...
enum SportType: String, CaseIterable, Identifiable, Sendable {
    ...
    nonisolated var endpoint: String {
        ...
        case .nrl: return "https://site.api.espn.com/apis/site/v2/sports/rugby-league/3/scoreboard"
        case .afl: return "https://site.api.espn.com/apis/site/v2/sports/australian-football/afl/scoreboard"
        case .nbl: return "https://site.api.espn.com/apis/site/v2/sports/basketball/nbl/scoreboard"
    ...
    nonisolated var needsDateRange: Bool {
        switch self {
        case .nrl, .afl, .nbl: return true
        default: return false
        }
    }

    nonisolated var fallbackBroadcasts: [String] {
        switch self {
        case .nrl: return ["Fox Sports 502", "Fox Sports 504"]
        case .afl: return []
        case .nbl: return []
        default: return []
        }
